...
export DYLD_FALLBACK_LIBRARY_PATH=${HOMEBREW_HOME}/Cellar/postgresql@14/14.5_5/lib/postgresql@14:$DYLD_FALLBACK_LIBRARY_PATH
export DYLD_FALLBACK_LIBRARY_PATH=${HOMEBREW_HOME}/Cellar/gcc/12.2.0/lib/gcc/12:$DYLD_FALLBACK_LIBRARY_PATH
